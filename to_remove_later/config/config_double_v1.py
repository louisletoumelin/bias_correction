...
from bias_correction.utils_bc.utils_config import assert_input_for_skip_connection, \
    ...
    detect_variable,\
    define_variables_needed
from bias_correction.config._config import config


config["input_variables_speed"] = None
config["input_variables_dir"] = None
config["nb_input_variables_speed"] = len(config["input_variables_speed"])
config["nb_input_variables_dir"] = len(config["input_variables_dir"])
config["label_speed"] = None
config["label_dir"] = None
...
config = define_variables_needed(config)
