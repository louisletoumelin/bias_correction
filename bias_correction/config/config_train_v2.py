...
# Architecture
config["details"] = "10_25_50"  # Str. Some details about the experiment
...
config["nb_units"] = [10, 25, 50]  # 25, 10               #todo 3 architectures                     # List. Each member is a unit [40, 20, 10, 5]
