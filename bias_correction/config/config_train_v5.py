...
# Architecture
config["details"] = "25_50_75_20"  # Str. Some details about the experiment
...
config["nb_units"] = [25, 50, 75, 20]  # 25, 10               #todo 3 architectures                     # List. Each member is a unit [40, 20, 10, 5]
