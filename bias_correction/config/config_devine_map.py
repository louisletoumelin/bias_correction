...
config[
    "global_architecture"] = "devine_only"  # Str. Default="ann_v0", "dense_only", "dense_temperature", "devine_only", "double_ann"
config["restore_experience"] = "2022_12_7_labia_v8"

# ann_v0
config["disable_training_cnn"] = True  # Bool. Default=True
config["type_of_output"] = "map"  # Str. "output_speed" or "output_components"
