...
config["global_architecture"] = "devine_only"  # Str. Default="ann_v0", "dense_only", "dense_temperature", "devine_only", "double_ann"
...
config["shuffle"] = False  # True. Bool. Shuffle inputs
...
# Time split
config["date_split_train_test"] = "2023-10-01"  # Str. Split train/test around this date
#                                                                         e.g. "2018-11-01"
config["date_split_train_val"] = "2023-10-01"
...
config["country_to_reject_during_training"] = False  # ["pyr", "corse"]
