...
from bias_correction.train.metrics import dict_metrics
...
if not config["restore_experience"]:
    ...
    print_headline("Launch loading layers", "")
    ...
    dependencies = {"tf_mae":dict_metrics["tf_mae"], "tf_rmse":dict_metrics["tf_rmse"], "tf_mbe":dict_metrics["tf_mbe"]}
    loaded_model = cm.load_external_model("/scratch/mrmn/letoumelinl/bias_correction/Data/3_Predictions/Experiences/2022_11_11_labia_v0/last_model/", custom_objects=dependencies)
    cm.load_previous_weights(loaded_model)
    #loaded_model = cm.load_external_model("/scratch/mrmn/letoumelinl/bias_correction/Data/3_Predictions/Experiences/2022_12_2_labia_v22/last_model/", custom_objects=dependencies)
    #cm.load_previous_weights(loaded_model, type_="dir")
