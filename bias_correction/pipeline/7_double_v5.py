...
from bias_correction.config.config_double_v5 import config
...
ALE = False
ALE_TWO_VARIABLES = True  #ALE_two_variables_dir_2022_13_01_v1
ALE_DELTA = False
    ...
    if ALE_DELTA:
        if cv == "uv":
            ...
            c_eval.plot_ale(cm,
                            ...
                            cmap="plasma",
                            marker='x',
                            folder_name="Delta_ALE_2022_13_01_dir_bias_dir_local_effects_false_v0",
                            exp=exp,
                            ylim=None,
                            markersize=1,
                            type_of_output="dir",
        ...
        if cv == "UV":
            ...
            with timer_context("ALE plot direction"):
                ...
                c_eval.plot_ale_two_variables(cm,
                                              ...
                                              marker='x',
                                              markersize=1,
                                              folder_name="ALE_two_variables_dir_2022_13_01_v0",
                                              type_of_output="dir",
                                              exp=exp,
                                              ylim=(-5, 5),
                                              linewidth=1)
