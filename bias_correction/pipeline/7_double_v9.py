...
from bias_correction.config.config_double_v9 import config
...
ALE = True  # ALE_dir_2022_13_01_std_local_effects_true_v1
        ...
        if cv == "UV":
            ...
            with timer_context("ALE plot direction"):
                ...
                c_eval.plot_ale(cm,
                                ...
                                cmap="plasma",
                                marker='x',
                                folder_name="ALE_dir_2022_13_01_std_local_effects_true_v0",
                                exp=exp,
                                ylim=None,
                                markersize=1,
                                type_of_output="dir",
